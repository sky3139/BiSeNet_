...
def predict_on_image(model, args):
    ...
    predict = colour_code_segmentation(predict.cpu().numpy(), label_info)
...
if __name__ == '__main__':
    params = [
        '--image',
        '--data', 'd.jpg',
        '--checkpoint_path', '/home/u20/code/BiSeNet/checkpoints_18_sgd/best_dice_loss.pth',
        '--cuda', '0',
        '--csv_path', '/home/u20/code/BiSeNet/dataset/CamVid/class_dict.csv',
        '--save_path', 'demo.png',
